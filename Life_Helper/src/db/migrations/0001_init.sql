-- Migration 0001: the entity spine (Decision 1) and the sync-ready
-- primitives it depends on (Decision 2). See docs/phase_A2_data_model.md
-- for the full rationale, including where this deviates from the plan's
