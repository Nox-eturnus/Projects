...
def load_discoveries_markdown(canonical: dict | None) -> str:
    ...
    lines = [
        ...
        f"no-pool-entanglement critical BA ≈ {_f(nopool_crit)} exceeds full. Removing all entanglement collapses to chance; removing the pooling hierarchy significantly damages critical-region generalization. Provisional until optimization convergence is fully established.",
